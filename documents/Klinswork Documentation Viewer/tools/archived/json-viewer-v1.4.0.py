...
Recommended layout:
    ...
    ├── workflows/
    ├── archived/
    └── open-json-viewer-v1.4.0.bat

Recommended launch command from the repository root:

    py -3 "%~dp0tools\json-viewer-v1.4.0.py" --folder "%~dp0"
...
APP_VERSION = "1.4.0"
BUILD_ID = "2026-08-01-workflow-preview-renderer"
HOST = "127.0.0.1"
...
<head>
  ...
  <title>Local JSON Explorer v1.4.0</title>
  <style>
    :root {
...
(() => {
  ...
  async function loadAbout() {
    try {
      ...
      els.runtimeInfo.textContent = "Version 1.4.0 · runtime identity unavailable";
    }
  }
